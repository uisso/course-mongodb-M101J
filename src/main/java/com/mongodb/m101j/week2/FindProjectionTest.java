...
public class FindProjectionTest {

    public static void main(String[] args) {
        MongoClient client = new MongoClient();
        MongoDatabase db = client.getDatabase("course");
        MongoCollection<Document> coll = db.getCollection("FindProjectionTest");
        coll.drop();
        ...
        // Bson projection = new Document("y", 1).append("i", 1).append("_id",
        // 0);
